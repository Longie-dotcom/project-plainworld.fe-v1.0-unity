...
namespace Assets.UI.HUD.CustomizeCharacter
{
    ...
    public class CustomizeCharacterPresenter
    {
        ...
        public void Dispose()
        {
            ...
            customizeCharacterView.OnViewShown -= OnViewShown;
        ...
        {
            // Reload current player appearance
        ...
        private CharacterAppearancePreview FromAppearance(IReadOnlyPlayerAppearance a)
        {
